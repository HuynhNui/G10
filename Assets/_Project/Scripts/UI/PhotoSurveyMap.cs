...
namespace G10.Prototype.UI
{
    ...
    public sealed class PhotoSurveyMap : MaskableGraphic
    {
        ...
        private MapPoi shownDestination;
        private Vector2 shownDestinationPosition;
        private float shownDepth = -1;
        ...
        private void Update()
        {
            ...
            UpdateTaskReadout();
            var destination = survey != null ? survey.TargetPoi : null;
            if (destinationReadout != null)
            {
